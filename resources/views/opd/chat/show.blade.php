                ...
                <form action="{{ route('opd.chat.send', $ticket) }}" method="POST" enctype="multipart/form-data" class="chat-composer-form" id="opd-chat-form">
                    ...
                    <div class="chat-attach-dropdown dropup">
                        ...
                        <ul class="dropdown-menu shadow-lg">
                            <li><a class="dropdown-item" href="#" onclick="openPicker('opd-pick-doc'); return false;"><i class="fas fa-file-alt me-2" style="color:#7c4dff"></i>Dokumen</a></li>
                            <li><a class="dropdown-item" href="#" onclick="openPicker('opd-pick-media'); return false;"><i class="fas fa-image me-2" style="color:#00bfa5"></i>Foto & Video</a></li>
                            <li><a class="dropdown-item" href="#" onclick="openPicker('opd-pick-camera'); return false;"><i class="fas fa-camera me-2" style="color:#ff1744"></i>Kamera</a></li>
                        </ul>
                    </div>
                    <span id="opd-attach-label" class="attach-name small text-muted text-truncate d-none" style="max-width:140px"></span>
...
bridgeFile(document.getElementById('opd-pick-doc'), 'opd-attach-real', 'opd-attach-label');
bridgeFile(document.getElementById('opd-pick-media'), 'opd-attach-real', 'opd-attach-label');
bridgeFile(document.getElementById('opd-pick-camera'), 'opd-attach-real', 'opd-attach-label');
</script>
@endpush
